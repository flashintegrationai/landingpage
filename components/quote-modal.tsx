        ...
        <div className="relative p-8 md:p-10">
          ...
          <DialogHeader className="mb-8">
            ...
            <DialogTitle className="font-(family-name:--font-orbitron) text-3xl md:text-4xl font-black text-foreground text-left leading-tight">
              {t("quoteModal.title1")} <br />
              <span className="text-[#1e71cd]">{t("quoteModal.title2")}</span>
            </DialogTitle>
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <div className="font-bold text-lg">{t("quoteModal.whatsapp")}</div>
                  <div className="text-white/70 text-xs uppercase tracking-widest font-medium">{t("quoteModal.whatsappSubText")}</div>
                </div>
              </div>
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all font-bold">
                 →
              </div>
            </Button>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <div className="font-bold text-lg">{t("quoteModal.call")}</div>
                  <div className="text-white/70 text-xs uppercase tracking-widest font-medium">{t("quoteModal.callSubText")}</div>
                </div>
              </div>
              <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all font-bold">
                 →
