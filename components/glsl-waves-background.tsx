          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: `
              ...
              void main(void) {
                ...
                // Mix colors based on height for water-like effect
                vec3 color = mix(deepBlue, midBlue, heightFactor);
                color = mix(color, lightBlue, pow(heightFactor, 2.0) * 0.5);
                
                // Add slight glow effect
                opacity *= 1.0 + heightFactor * 0.3;
...
export default GLSLWavesBackground;
